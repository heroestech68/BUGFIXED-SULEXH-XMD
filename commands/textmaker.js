...
const messageTemplates = {
    ...
    success: (text, imageUrl) => ({
        image: { url: imageUrl },
        caption: "GENERATED BY BUGFIXED-SULEXH-XMD",
        contextInfo: channelInfo
    })
};
...
async function textmakerCommand(sock, chatId, message, q, type) {
    try {
        ...
        console.error("Textmaker main error:", error);
        await sock.sendMessage(chatId, messageTemplates.error("An error occurred. Try again later."));
    }
}
